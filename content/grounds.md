...
In middles school, it's mandatory to "analyse" [[Os Lusíadas]], as well as studying the interpretation of [[A Mensagem]]. Yet the efforts to reflect upon the contemporary and huge underlying issue behind these two texts are minimal if even existent. In 8th grade History books while there is a slight connection between the "discoveries" and violence (found on the side notes), there is no mention of our founding contribution to the Atlantic enslaved trade, for how long it occurred, how many people were involved, or its overall impact in the present day, instead you learn about the chronology of occupation and economic aspects, that converge in "Portugal was the main economic European power in the second half of XVI".[^historia] Putting that aside, once we move into 9th grade Portuguese, [[Os Lusíadas]]  is taught under the framework of narrative text, epic poetry, pronouns, rhymes, metaphors, perifrasis, etc., i.e. "objectively", without any mention to colonisation.[^portugues] The connection between the two is omitted.
